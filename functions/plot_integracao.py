...
def _plot(object_ra, object_dif, object_both, object_normal):
    ...
    plt.xlabel("Tempo [s]")
    plt.ylabel("Volume [L]")
    plt.plot(object_both.t[-37500:], np.array(object_ra.y_mp["VD"])[-37500:], color="r", label="RbA", marker = 'o')
    plt.plot(object_both.t[-37500:], np.array(object_dif.y_mp["VD"])[-37500:], color="b", label="difusao", marker = '+')
    plt.plot(object_both.t[-37500:], np.array(object_both.y_mp["VD"])[-37500:], color="g", label="ambos")
    plt.plot(object_both.t[-37500:], np.array(object_normal.y_mp["VD"])[-37500:], color="y", label="normal")
    plt.legend(loc="upper left")
    plt.savefig("temp/dpoc/VD")
    ...
    plt.xlabel("Tempo [s]")
    plt.ylabel("Volume [L]")
    plt.plot(object_both.t[-37500:], np.array(object_ra.y_mp["VA"])[-37500:], color="r", label="RbA", marker = 'o')
    plt.plot(object_both.t[-37500:], np.array(object_dif.y_mp["VA"])[-37500:], color="b", label="difusao", marker = '+')
    plt.plot(object_both.t[-37500:], np.array(object_both.y_mp["VA"])[-37500:], color="g", label="ambos")
    plt.plot(object_both.t[-37500:], np.array(object_normal.y_mp["VA"])[-37500:], color="y", label="normal")
    plt.legend(loc="upper left")
    plt.savefig("temp/dpoc/VA")
    ...
    plt.xlabel("Tempo [s]")
    plt.ylabel("Volume [L/s]")
    plt.plot(object_both.t[-37500:], np.array(object_ra.y_mp["VA_dot"])[-37500:], color="r", label="RbA", marker = 'o')
    plt.plot(object_both.t[-37500:], np.array(object_dif.y_mp["VA_dot"])[-37500:], color="b", label="difusao", marker = '+')
    plt.plot(object_both.t[-37500:], np.array(object_both.y_mp["VA_dot"])[-37500:], color="g", label="ambos")
    plt.plot(object_both.t[-37500:], np.array(object_normal.y_mp["VA_dot"])[-37500:], color="y", label="normal")
    plt.legend(loc="upper left")
    plt.savefig("temp/dpoc/VA_dot")
    ...
    plt.plot(object_both.t[-37500:], np.array(object_normal.y_tg["P_cap_O2"])[-37500:], color="y", label="normal")
    plt.legend(loc="upper left")
    plt.savefig("temp/dpoc/PaO2")
